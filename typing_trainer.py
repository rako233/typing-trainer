...
SPECIAL_KEYS = {'degree': '°', 'asciicircum': '^', 'exclam': '!', 'quotedbl': '"',
                ...
                'Aacute':'Á', 'Agrave':'À', 'Eacute':'É', 'Egrave':'È', 'Iacute':'Í', 'Igrave':'Ì',
                'Oacute':'Ó', 'Ograve':'Ò', 'Uacute':'Ú', 'Ugrave':'Ù',
                'oslash':'ø', 'Oslash':'Ø', 'ae':'æ', 'AE':'Æ', 'aring':'å', 'Aring':'Å'}
...
class WikiLang():
    ...
    def __init__(self, parent, default="English"):
        ...
        self.value = tk.Spinbox(parent, values=("English", "Español", "Deutsch", "Bokmål"), textvariable=self.var,
...
class TrainText(tk.Text):
    def __init__(self, frame, max_words, word_counter, language):
        ...
        super().__init__(frame, wrap=tk.WORD, bg="white smoke", height=20, width=70,
                         font=('monospace', 18), yscrollcommand=vbar.set,
        ...
        self.text = ''
        self.link = ''
        self.lang_codes ={'English':'en', "Español":'es', "Deutsch":'de', 'Bokmål':'nb'}
        self.lang = language
        self.characters = 0
...
def get_wiki_text(max_length, lang):
    ...
    wiki = {'en':"Wikipedia:Featured articles", 'es':'Wikipedia:Artículos destacados', 'de':'Wikipedia:Exzellente Artikel', 'nb':'Wikipedia:Utmerkede artikler'}
